...
def main(args):
    ...
    O_3_base = shapely.geometry.box(600, 200, 800, 450)
    O_4_base = shapely.geometry.Polygon([(600, 800), (550, 900), (750, 900), (700, 800), (650, 750), (600, 800)])
    O_3 = O_3_base.buffer(2)
    O_4 = O_4_base.buffer(2)
    c_obstacles = [O_1, O_2, O_3, O_4]
    ...
    #plt.show()
    plt.savefig("fig63.png")

if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description = "Compute and plot configuration space for 2D manipulator for exec 6.3")
    parser.add_argument(
		  "precision",
          type=float,
          nargs="?",
